...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-H6XCVPTP.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-F6ROHTIU.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-HXJ6LVNJ.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-TQCAKDM7.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-I3U2YH3R.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-YKPIJILB.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-QH7KJS4K.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-LO3UMHJ4.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-Q6TVGP6I.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-ECTQPWJK.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-YB5B7X65.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-5HDEVXEX.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "0a2654e";
        const gitBranch = "dev";
        const buildTime = "2026-05-22T15:52:57.019Z";

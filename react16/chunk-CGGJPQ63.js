...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-5LYW4XJ2.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-4JOWICIM.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-JM4LLUXX.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-PH24QEP2.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-DISRAFHV.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-IKCP7I54.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-F6NV5KET.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-QDS37QQ4.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-ARIMYFGS.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-LH5LZZ3G.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-FVPRVM3F.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-ZFJJK6T2.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "5af6a73";
        const gitBranch = "dev";
        const buildTime = "2026-04-28T14:13:36.675Z";
